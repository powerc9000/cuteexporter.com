...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.2fc01a828bd6f746be2e71888731bd419a3567faf8a8e83d0ba467b7d8e9a943.js',function(){input.required=false;search();});}
