...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.c6ebd01ef478d106aa5ff520967525024f84d0c2fda0b1dae21e186783ff3ebc.js',function(){input.required=false;search();});}
